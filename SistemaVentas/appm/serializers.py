...
from .models import Clientes, Productos, Empresas, Orden, Proveedores, Empleados
...
class OrdenSerializer(serializers.ModelSerializer):
    class Meta:
        model = Orden
        fields = ['codigo_orden', 'fecha_orden', 'cliente', 'empleado', 'producto', 'cantidad','subtotal', 'iva', 'total']
